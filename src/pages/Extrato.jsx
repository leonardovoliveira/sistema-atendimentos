    ...
    return (
      <tr key={atendimento.id} className="hover:bg-gray-50 transition-colors">
        <td className="px-3 py-2 text-sm">
          {new Date(atendimento.data_atendimento + 'T00:00:00').toLocaleDateString('pt-BR')}
        </td>
        ...
        <td className="px-3 py-2 text-sm">
          {atendimento.data_prevista_pagamento ? 
            new Date(atendimento.data_prevista_pagamento + 'T00:00:00').toLocaleDateString('pt-BR') : '-'}
        </td>
        <td className="px-3 py-2 text-sm">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {atendimentos.length === 0 ? (
                  ...
                  atendimentos
                    ...
                    .map(atendimento => renderLinha(atendimento))
                )}
              </tbody>
            </table>
          </div>
